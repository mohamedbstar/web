              ...
              <div className='msgs w-[30%] h-[100%] bg-slate-100 flex flex-col p-2'>
                ...
                <div className='overflow-y-scroll mt-2'>
                  ...
                  {/* render chats here */ chats.length > 0 &&
                    chats.map((c) => {
                      return (
                        <div className='w-[100%] py-2 my-2 bg-white text-center rounded-lg cursor-pointer relative' onClick={() => {
                          setCurChat(c);
                          setDummy(!dummy);
                          ...
                          {
                            c.lastMessage && !c.lastMessage.seen && <div className={`w-2 h-2 rounded-full bg-red-500 absolute top-1 right-2`}>
                            </div>
                          }
                        </div>
                      )
