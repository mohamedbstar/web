...
const register = asyncControllerWrapper(
    async (req, res, next) => {
        ...
        const newUser = new UserModel({ name, email, role, password: hashedPass });

        //handle profile pic
        const profilePic = req.profilePic || "/uploads/profile.png";
...
const checkPassword = asyncControllerWrapper(
    async (req, res, next) => {
...
const UserController = { register, login, getAllUsers, getUser, editUser, deleteUser, forgotPassword, verifyOtp, getUserByEmail }
